...
export default {
    ...
    actions: {
        ...
        async FETCH_OPENWEATHER_API(context) {
            ...
            try {
                const res = await axios.get(`https://api.openweathermap.org/data/2.5/onecall?lat=${initialLat}&lon=${initialLon}&appid=${process.env.VUE_APP_WEATHER_API_KEY}&units=metric`);
